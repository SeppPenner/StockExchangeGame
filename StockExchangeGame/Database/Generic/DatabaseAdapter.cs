...
namespace StockExchangeGame.Database.Generic
{
    ...
    public class DatabaseAdapter : IDatabaseAdapter
    {
        ...
        public ObservableCollection<T> Get<T, TValue>(Expression<Func<T, bool>> predicate = null, Expression<Func<T, TValue>> orderBy = null)
        {
            ...
            if (typeof(T) == typeof(CompanyEndings))
            {
                return _companyEndingsController.Get(predicate as Expression<Func<CompanyEndings, bool>>, orderBy as Expression<Func<CompanyEndings, TValue>>) as ObservableCollection<T>;
            }
            if (typeof(T) == typeof(CompanyNames))
            {
                return _companyNamesController.Get(predicate as Expression<Func<CompanyNames, bool>>, orderBy as Expression<Func<CompanyNames, TValue>>) as ObservableCollection<T>;
            }
            if (typeof(T) == typeof(DummyCompany))
            {
                return _dummyCompanyController.Get(predicate as Expression<Func<DummyCompany, bool>>, orderBy as Expression<Func<DummyCompany, TValue>>) as ObservableCollection<T>;
            }
            if (typeof(T) == typeof(Merchant))
            {
                return _merchantController.Get(predicate as Expression<Func<Merchant, bool>>, orderBy as Expression<Func<Merchant, TValue>>) as ObservableCollection<T> as ObservableCollection<T>;
            }
            if (typeof(T) == typeof(Names))
            {
                return _namesController.Get(predicate as Expression<Func<Names, bool>>, orderBy as Expression<Func<Names, TValue>>) as ObservableCollection<T>;
            }
            if (typeof(T) == typeof(Sold))
            {
                return _soldController.Get(predicate as Expression<Func<Sold, bool>>, orderBy as Expression<Func<Sold, TValue>>) as ObservableCollection<T>;
            }
            if (typeof(T) == typeof(Stock))
            {
                return _stockController.Get(predicate as Expression<Func<Stock, bool>>, orderBy as Expression<Func<Stock, TValue>>) as ObservableCollection<T>;
            }
            if (typeof(T) == typeof(StockHistory))
            {
                return _stockHistoryController.Get(predicate as Expression<Func<StockHistory, bool>>, orderBy as Expression<Func<StockHistory, TValue>>) as ObservableCollection<T>;
            }
            if (typeof(T) == typeof(StockMarket))
            {
                return _stockMarketController.Get(predicate as Expression<Func<StockMarket, bool>>, orderBy as Expression<Func<StockMarket, TValue>>) as ObservableCollection<T>;
            }
            if (typeof(T) == typeof(Surnames))
            {
                return _surnamesController.Get(predicate as Expression<Func<Surnames, bool>>, orderBy as Expression<Func<Surnames, TValue>>) as ObservableCollection<T>;
            }
            if (typeof(T) == typeof(Taxes))
            {
                return _taxesController.Get(predicate as Expression<Func<Taxes, bool>>, orderBy as Expression<Func<Taxes, TValue>>) as ObservableCollection<T>;
            }
            return null;
        }
